def calculate_average(numbers):
    ...
    try:
        ...
        print(
            f"Zero division error has occured, an empty list has been passed as an argument.\nERROR: {ZeroDivisionError}"
        )
...
def get_list_element(my_list, index):
    try:
        ...
        print(
            f"ERROR: Index passed is out of bounds, the number of elements is {len(my_list)}, but index {index} was requested\nERROR: {IndexError}"
        )
        return None
    except TypeError:
